...
export function parseBinary(binary: any) {
	...
	const magic = data.readUint8Array(MAGIC.length).every(function (v: any, i: any) { return v === MAGIC[i]; });
    if (!magic)
        throw 'Not a binary FBX file';
...
function readNode(data: any, header64: any) {
...
const read = {
    Y: function (data: any) { return data.readInt16(); },
    C: function (data: any) { return data.readUint8AsBool(); },
    I: function (data: any) { return data.readInt32(); },
    F: function (data: any) { return data.readFloat32(); },
    D: function (data: any) { return data.readFloat64(); },
    L: function (data: any) { return data.readInt64(); },
    f: function (data: any) { return readPropertyArray(data, function (r: any) { return r.readFloat32(); }); },
    d: function (data: any) { return readPropertyArray(data, function (r: any) { return r.readFloat64(); }); },
    l: function (data: any) { return readPropertyArray(data, function (r: any) { return r.readInt64(); }); },
    i: function (data: any) { return readPropertyArray(data, function (r: any) { return r.readInt32(); }); },
    b: function (data: any) { return readPropertyArray(data, function (r: any) { return r.readUint8AsBool(); }); },
    S: function (data: any) { return data.readArrayAsString(data.readUint32()); },
    R: function (data: any) { return data.readUint8Array(data.readUint32()); },
};

function readProperty(data: any) {
    const typeCode = data.readUint8AsString();

    if (typeof (read as any)[typeCode] === 'undefined')
        throw "Unknown Property Type " + typeCode.charCodeAt(0);
	
    let value = (read as any)[typeCode](data);
...
function readPropertyArray(data: any, reader: any) {
